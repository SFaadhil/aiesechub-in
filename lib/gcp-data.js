...
// Entities not currently open for new submissions (inactive/expanded-out LCs
// with historical GCPs only) — still filterable on the hub via GCP_ENTITIES,
// just hidden from the "Uploader Entity" picker on the submit form.
const CLOSED_FOR_SUBMISSION = new Set([
  'AIESEC in Bhubaneswar',
  'AIESEC in IIT Kharagpur',
  'AIESEC in Jodhpur',
  'AIESEC in NMIMS Shirpur',
...
export const GCP_SUBMIT_ENTITIES = GCP_ENTITIES.filter((e) => !CLOSED_FOR_SUBMISSION.has(e));
