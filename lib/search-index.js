...
const PAGES = [
  ...
  { id: 'functional-hub',   title: 'Functional Hub',          group: 'pages', badge: 'Page', accent: '#037ef3', href: '/functional-hub',     desc: 'Resources and tools for all AIESEC India portfolios in one place.',                                       keywords: 'functional hub portfolios igv ogv igta igte ogta mkt bd pm fnl im od expansions' },
...
const AIESEC_INDIA_SECTIONS = [
  { id: 'ai-history',  title: 'Our History',      group: 'aiesec-india', badge: 'AIESEC India', accent: '#037ef3', href: '/aiesec-india', desc: 'The story and growth of AIESEC in India since 1959.', keywords: 'history aiesec india 1959 1981 founded established organisation' },
  { id: 'ai-mc',       title: 'MC Conquerors',    group: 'aiesec-india', badge: 'AIESEC India', accent: '#037ef3', href: '/aiesec-india', desc: 'Member Committee 26.27 of AIESEC in India — the national leadership team.', keywords: 'mc member committee conquerors mcvp team leadership 2627 national' },
  { id: 'ai-contact',  title: 'MC Contact List',  group: 'aiesec-india', badge: 'AIESEC India', accent: '#037ef3', href: '/aiesec-india', desc: 'Contact details for all MC members — phone, .in and .ID emails.', keywords: 'mc contact list phone email aiesec.in aiesecmember.in reach' },
  { id: 'ai-advisors', title: 'Board of Advisors',group: 'aiesec-india', badge: 'AIESEC India', accent: '#037ef3', href: '/aiesec-india', desc: 'Guiding AIESEC in India with experience and expertise.', keywords: 'board advisors guidance experience expertise senior advisory' },
  { id: 'ai-comp',     title: 'Compendium',       group: 'aiesec-india', badge: 'AIESEC India', accent: '#037ef3', href: '/aiesec-india', desc: "AIESEC in India's governing policy documents.", keywords: 'compendium governing policy documents constitution rules regulations legal governance india' },
];
...
// ── RnR main sections ────────────────────────────────────────────────────────
const RNR_SECTIONS = [
  { id: 'rnr-dashboard',   title: 'National Dashboard',        group: 'rnr', badge: 'RnR', accent: '#0f172a', href: '/rnr', desc: 'Per-portfolio tier standings and monthly points for every LC.',                    keywords: 'dashboard standings rank points portfolio monthly lc national leaderboard tier badge' },
  { id: 'rnr-recognition', title: 'Monthly Recognition Table', group: 'rnr', badge: 'RnR', accent: '#0f172a', href: '/rnr', desc: 'LCs recognised at each tier level for every portfolio, filtered by month.',       keywords: 'monthly recognition table tier april march february portfolio lc recognised awards' },
  { id: 'rnr-tiers',       title: 'Portfolio Tiers',           group: 'rnr', badge: 'RnR', accent: '#0f172a', href: '/rnr', desc: 'LC tier assignments across all portfolios for the current term.',                  keywords: 'tier structure portfolio assignments term standings tier 1 2 3 4 5 x expansion' },
  { id: 'rnr-metrics',     title: 'Points Framework',          group: 'rnr', badge: 'RnR', accent: '#0f172a', href: '/rnr', desc: 'Per-portfolio scoring parameters, weightages, and point scales for all LCs.',     keywords: 'points framework metrics parameters weightage scale apd re co finco apl bd revenue mkt su sign ups' },
];
